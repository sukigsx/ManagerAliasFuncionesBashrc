...
NombreScriptActualizar="ManagerAliasFuncionesBashrc.sh" #contiene el nombre del script para poder actualizar desde github
DireccionGithub="https://github.com/sukigsx/ManagerAliasFuncionesBashrc" #contiene la direccion de github para actualizar el script
